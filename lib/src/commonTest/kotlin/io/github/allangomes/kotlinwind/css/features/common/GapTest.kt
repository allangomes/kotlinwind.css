...
class GapTest {
  ...
  @Test
  fun gap_1() {
    val expected: String = Style(GAP, "1rem").toString()
  ...
  @Test
  fun gap_1_5() {
    val expected: String = Style(GAP, "1.25rem").toString()
    val returned = KW.inline { grid.gap[5f] }
    assertEquals(expected, returned)
  }

  @Test
  fun gap_x() {
    val expected: String = Style(GAP_COLUMN, "1rem").toString()
  ...
  @Test
  fun gap_y() {
    val expected: String = Style(GAP_ROW, "1rem").toString()
  ...
  @Test
  fun flex_support() {
    val expected = Style(GAP,"1rem").toString()
